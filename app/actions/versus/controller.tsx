...
import { connectPlayer, disconnectStream, relayUpdate, reportFinish } from '../../multiplayer/hub.ts'
  ...
  actions: {
    ...
    async index(context) {
      ...
      return context.render(
        <VersusPage user={user} theme={theme} mode={VERSUS_MODE} />,
      )
    },
    ...
    async show(context) {
      ...
      let theme = await readTheme(context.request)
      return context.render(
        <VersusReplayPage game={game} viewer={viewer} theme={theme} />,
      )
    },
  },
})
